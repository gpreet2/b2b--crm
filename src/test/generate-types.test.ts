...
describe('Type Generation', () => {
  ...
  it('should generate valid TypeScript type exports', () => {
    ...
    expect(content).toContain('export type UserProfile = z.infer<typeof schemas.userProfileSchema>');
  ...
  it('should export enum types correctly', () => {
    ...
    expect(content).toContain('export type MembershipStatus = z.infer<typeof schemas.membershipStatusEnum>');
