  ...
  return (
    <div>
      <div className="mb-4 sm:mb-6">
        ...
        <p className="text-sm sm:text-body text-secondary-text">Track workouts and manage exercise library</p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="p-4 sm:p-8 text-center text-muted">
            ...
            <p className="text-xs sm:text-body-sm">Track daily workouts, view exercise library, and monitor progress</p>
          </div>
        </CardContent>
      </Card>
    </div>
