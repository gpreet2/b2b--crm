          ...
          <div className='flex flex-col sm:flex-row sm:items-center justify-between gap-4'>
            <div className='flex items-center space-x-4'>
              <div>
                ...
                <p className='text-sm sm:text-base text-secondary-text font-light'>
                  Track your daily workouts and performance
                </p>
              </div>
            </div>
                ...
                <select
                  ...
                  onChange={e => {
                    ...
                    announceToScreenReader(
                      `Filter changed to ${e.target.options[e.target.selectedIndex].text}`
                    );
                  }}
