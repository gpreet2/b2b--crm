            ...
            <div className="max-w-md">
              <div className="mb-8">
                ...
                <p className="text-body-lg opacity-90 leading-relaxed">
                  Streamline operations, boost member engagement, and scale your
                  fitness business with our comprehensive management platform.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-body font-heading mb-1">
                      Member Management
                    </h3>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-body-sm opacity-80">
                      Optimize facility usage and bookings
                    </p>
                  </div>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="relative my-4">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-surface text-secondary-text">
                      Or continue with
                    </span>
                  </div>
                </div>
