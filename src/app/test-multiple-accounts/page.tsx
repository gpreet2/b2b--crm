    ...
    <div className="min-h-screen bg-gradient-to-br from-surface via-surface-light to-accent flex items-center justify-center p-8">
      <Card className="max-w-2xl w-full p-8">
        ...
        <div className="space-y-4 text-secondary-text">
          <p>
            WorkOS maintains session cookies on their domain (api.workos.com) that persist across local signouts.
            This can make testing multiple accounts challenging during development.
          </p>
          
          <div className="bg-warning/10 border border-warning/20 rounded-lg p-4">
            <p className="font-semibold text-warning mb-2">⚠️ Known Issue:</p>
            <p className="text-sm">
              After creating an account, WorkOS will auto-authenticate you with that account even when trying to create a new one.
            </p>
          </div>
            ...
            <div className="space-y-2">
              <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted">Open a new incognito window for each test account</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted">Test each account in a different browser (Chrome, Firefox, Safari, etc.)</p>
                </div>
              </div>
          ...
          <div className="bg-primary/5 border border-primary/10 rounded-lg p-4 mt-6">
            <p className="text-sm">
              <strong>Note:</strong> This is only an issue during local development. In production, users won't typically need to create multiple accounts with different emails on the same device.
            </p>
          </div>
        </div>
