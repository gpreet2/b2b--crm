  ...
  return (
    <div>
      <div className="mb-4 sm:mb-6">
        ...
        <p className="text-sm sm:text-body text-secondary-text">Manage invoices, transactions, and payroll</p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="p-4 sm:p-8 text-center text-muted">
            ...
            <p className="text-xs sm:text-body-sm">Track revenue, manage invoices, and handle financial operations</p>
          </div>
        </CardContent>
      </Card>
    </div>
