  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-surface via-surface-light to-accent p-8'>
      <div className='max-w-4xl mx-auto space-y-6'>
        <Card className='p-8'>
          <h1 className='text-2xl font-bold text-primary-text mb-6'>Test Refresh Token Endpoint</h1>
          ...
          <div className='space-y-4'>
            ...
            {sessionStatus ? <div className='mt-6 p-4 bg-info/10 border border-info/20 rounded-lg'>
            ...
            {refreshResult ? <div className='mt-4 p-4 bg-success/10 border border-success/20 rounded-lg'>
                <h3 className='font-medium text-success mb-2'>Refresh Result:</h3>
                <pre className='text-xs overflow-auto whitespace-pre-wrap'>
                  {JSON.stringify(refreshResult, null, 2)}
                </pre>
                {refreshResult.refreshIn ? <p className='mt-2 text-sm text-success'>
                    Next refresh recommended in: {Math.round(refreshResult.refreshIn / 1000 / 60)}{' '}
                    minutes
                  </p> : null}
              </div> : null}
          </div>
