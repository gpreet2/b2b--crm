  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-surface via-surface-light to-accent">
      <div className="text-center">
        ...
        <h2 className="text-xl font-semibold text-primary-text mb-2">Preparing your account setup...</h2>
        <p className="text-sm text-secondary-text">Please wait while we prepare the onboarding process</p>
      </div>
    </div>
  );
}