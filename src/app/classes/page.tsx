            ...
            <div className='grid grid-cols-2 lg:grid-cols-4 gap-6 mb-8'>
              {keyMetrics.map((metric, index) => (
                <div key={index} className='group'>
                  <div
                    className={`bg-gray-50 border ${metric.accentColor} rounded-xl p-6 hover:shadow-xl hover:shadow-${metric.color.split('-')[1]}-500/20 transition-all duration-300 relative overflow-hidden card-animate`}
                  >
                    {/* Accent bar */}
                    <div
                      className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${
                        metric.color === 'text-red-500'
                          ...
                          : metric.color === 'text-emerald-500'
                            ? 'from-emerald-600 to-emerald-700'
                            : metric.color === 'text-amber-500'
                    ...
                    <div>
                      <h3
                        className={`text-3xl font-bold ${metric.color} mb-2 group-hover:scale-105 transition-transform`}
                      >
                        {metric.value}
                      </h3>
                      ...
                      <div className='bg-gray-50 border border-gray-200 rounded-xl p-6 hover:shadow-xl hover:border-gray-300 transition-all duration-300 relative overflow-hidden card-animate'>
                        ...
                        <div className='relative'>
                          <div className='flex items-center justify-between mb-4'>
                            <div
                              className={`p-3 rounded-xl bg-gradient-to-br ${action.gradient} shadow-lg group-hover:shadow-xl transition-shadow duration-300`}
                            >
                        ...
                        <div className='flex items-start justify-between'>
                          <div className='flex-1 min-w-0'>
                            <div className='flex items-center space-x-3 mb-3'>
                              ...
                              <div
                                className={`px-3 py-1 rounded-full text-xs font-bold border ${getStatusColor(classItem.status)} flex items-center space-x-1`}
                              >
