        ...
        <CardContent>
          <div className='grid grid-cols-2 lg:grid-cols-4 gap-4'>
            {eventCategories.map((category, index) => (
              ...
              >
                <div
                  className={`p-2 rounded-lg ${category.color} flex items-center justify-center`}
                >
        ...
        <CardContent>
          <div className='space-y-6'>
            {upcomingEvents.map(event => (
              ...
              >
                {event.featured ? <div className='absolute -top-2 -right-2'>
                  ...
                  <div className='flex-1'>
                    <div className='flex items-start justify-between mb-3'>
                      <div>
                        ...
                        <p className='text-body-sm text-secondary-text mb-3'>{event.description}</p>
                      </div>
                    ...
                    <div className='flex items-center justify-between mt-4'>
                      <div className='flex items-center space-x-4'>
                        <span className='text-body-sm text-secondary-text'>
                          Instructor:{' '}
                          <span className='font-medium text-primary-text'>{event.instructor}</span>
                        </span>
                        <span className='text-body font-medium text-primary'>{event.price}</span>
                      </div>
