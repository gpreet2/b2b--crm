      ...
      <CardContent className='p-4'>
        ...
        <div className='flex items-center justify-between mb-4'>
          ...
          <div className='flex items-center space-x-2'>
            ...
            {onToggleExpanded ? <Button variant='outline' size='sm' onClick={onToggleExpanded}>
          ...
          <div>
            ...
            <div className='flex flex-wrap gap-2'>
              ...
              {!isExpanded && programs.length > 4 && (
                <span className='text-xs text-gray-500 px-2 py-1'>+{programs.length - 4} more</span>
              )}
            </div>
          </div>
          ...
          <div>
            ...
            <div className='flex flex-wrap gap-2'>
              {coaches
                ...
                .slice(0, isExpanded ? coaches.length : 3)
                .map(coach => (
                  <button
                    key={coach.id}
                    type='button'
              ...
              {!isExpanded && coaches.length > 3 && (
                <span className='text-xs text-gray-500 px-2 py-1'>+{coaches.length - 3} more</span>
              )}
            </div>
          </div>
        ...
        {/* Expanded Filters */}
        {isExpanded ? <div className='border-t border-gray-200 pt-4 space-y-4'>
            {/* Date Range */}
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              ...
              <div>
                <label className='block text-sm font-medium text-gray-700 mb-2'>Latest Time</label>
                <Input
                  type='time'
        ...
        {activeFilterCount > 0 && (
          <div className='mt-4 pt-4 border-t border-gray-200'>
            <div className='flex items-center justify-between'>
              ...
              <div className='flex flex-wrap gap-2'>
                {filters.search ? <span className='inline-flex items-center px-2 py-1 text-xs bg-gray-100 text-gray-800 rounded'>
