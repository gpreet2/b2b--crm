      ...
      <DialogContent className='max-w-md'>
        <DialogHeader className='px-8 pt-8 pb-6'>
          <DialogTitle className='flex items-center space-x-4 text-primary-text font-light'>
            <div className='w-6 h-6 rounded-xl shadow-lg' style={{ backgroundColor }} />
        ...
        <div className='px-8 pb-8 space-y-6'>
          ...
          <div className='p-6 bg-gradient-to-r from-surface-light/30 to-surface-light/10 rounded-2xl backdrop-blur-sm'>
            <div className='space-y-4'>
              <div className='flex items-center space-x-4'>
                ...
                <div>
                  <p className='text-sm font-light text-primary-text'>{formatDate(start)}</p>
              ...
              {location ? <div className='flex items-center space-x-4'>
                  <div className='p-2 bg-primary/20 rounded-xl'>
          ...
          <div className='p-6 bg-gradient-to-r from-surface-light/30 to-surface-light/10 rounded-2xl backdrop-blur-sm'>
            <div className='space-y-4'>
              <div className='flex items-center justify-between'>
                ...
                <span
                  className={`text-xs font-light px-3 py-1 rounded-full bg-surface-light/50 ${getStatusColor(status)}`}
                >
          ...
          {/* Description */}
          {description ? <div className='p-6 bg-gradient-to-r from-surface-light/30 to-surface-light/10 rounded-2xl backdrop-blur-sm'>
