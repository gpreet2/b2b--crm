        ...
        <form onSubmit={handleSubmit} className='px-8 pb-8 space-y-8'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div>
              ...
              />
              {errors.name ? <p className='text-danger text-xs mt-2 font-light'>{errors.name}</p> : null}
            </div>

            <div>
              <label className='block text-sm font-light text-primary-text mb-3'>Location</label>
              <Input
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div>
              <label className='block text-sm font-light text-primary-text mb-3'>Program *</label>
              <select
              ...
              {errors.programId ? <p className='text-danger text-xs mt-2 font-light'>{errors.programId}</p> : null}
              {selectedProgram ? <div className='mt-3 flex items-center space-x-3 p-3 bg-surface-light/30 rounded-xl'>
                  <div
                    className='w-4 h-4 rounded-full shadow-sm'
                    style={{ backgroundColor: selectedProgram.color }}
                  />
                  <span className='text-sm text-secondary-text font-light'>
            ...
            <div>
              <label className='block text-sm font-light text-primary-text mb-3'>Coach *</label>
              <select
              ...
              {errors.coachId ? <p className='text-danger text-xs mt-2 font-light'>{errors.coachId}</p> : null}
              {selectedCoach ? <div className='mt-3 flex items-center space-x-3 p-3 bg-surface-light/30 rounded-xl'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
            <div>
              <label className='block text-sm font-light text-primary-text mb-3'>Date *</label>
              ...
              {errors.date ? <p className='text-danger text-xs mt-2 font-light'>{errors.date}</p> : null}
            </div>
            ...
            <div>
              ...
              {errors.startTime ? <p className='text-danger text-xs mt-2 font-light'>{errors.startTime}</p> : null}
            </div>

            <div>
              <label className='block text-sm font-light text-primary-text mb-3'>End Time *</label>
              <div className='relative'>
                <ClockIcon className='absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-primary' />
                <Input
                  type='time'
              ...
              {errors.endTime ? <p className='text-danger text-xs mt-2 font-light'>{errors.endTime}</p> : null}
            </div>
          </div>
          ...
          {/* Recurring Options */}
          {formData.isRecurring ? <div className='space-y-6 p-6 bg-gradient-to-r from-surface-light/30 to-surface-light/10 rounded-2xl backdrop-blur-sm'>
              <div className='flex items-center space-x-3'>
              ...
              <div>
                ...
                {errors.recurringDays ? <p className='text-danger text-xs mt-2 font-light'>{errors.recurringDays}</p> : null}
              </div>
              ...
              <div>
                ...
                />
                {errors.recurringEndDate ? <p className='text-danger text-xs mt-2 font-light'>{errors.recurringEndDate}</p> : null}
              </div>
            </div> : null}

          {/* Description */}
          <div>
            <label className='block text-sm font-light text-primary-text mb-3'>Description</label>
            <textarea
