  ...
  return (
    ...
    >
      ...
      <div id="sidebar-instructions" className="sr-only">
        Use arrow keys to navigate workouts. Press Enter or Space to select a workout. Press F to toggle favorites. Press Delete or Backspace to delete custom templates. Press / to search. Press Ctrl/Cmd + N to add new template. Press Escape to close.
      </div>
            ...
            {filteredWorkouts.map((workout, index) => {
              ...
              return (
                ...
                >
                      ...
                      <div className="flex items-center space-x-3 flex-1">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center space-x-2">
                            <h4 className="font-medium text-primary-text truncate">{workout.title}</h4>
                            {isProgram && (
                    ...
                    {!isExpanded && (
                      <div className="text-center mt-2">
                        <div className={`text-xs transition-all duration-300 ${
                          ...
                          {draggedWorkout?.id === workout.id ? '✨ Dragging to modal...' : '🎯 Drag to add workout'}
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  {/* Expanded Content */}
                  {isExpanded && (
                    <div className="px-3 pb-3 border-t border-border-light/50">
                  ...
                  <div id={`workout-${workout.id}-details`} className="sr-only">
                    ...
                    {workout.isFavorite && ' This workout is in your favorites.'}
                  </div>
                </div>
              )
            })}
