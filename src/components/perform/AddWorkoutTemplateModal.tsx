      ...
      >
        ...
        <div className='flex-shrink-0 p-6 bg-gradient-to-r from-surface-light/50 to-surface-light/30 border-b border-border/30'>
          <div className='flex items-center justify-between'>
            <div>
              <h2 id='template-modal-title' className='text-xl font-semibold text-primary-text'>
                Create Workout Template
              </h2>
              <p id='template-modal-description' className='text-sm text-secondary-text mt-1'>
        ...
        <div className='flex-1 overflow-y-auto p-6 space-y-6'>
          ...
          <div className='space-y-4'>
            <div>
              ...
              />
              {errors.title ? <p id='title-error' className='text-red-500 text-xs mt-1' role='alert'>
                  {errors.title}
                </p> : null}
            </div>
            ...
            <div>
              ...
              />
              {errors.description ? <p id='description-error' className='text-red-500 text-xs mt-1' role='alert'>
                  {errors.description}
                </p> : null}
            </div>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-3 gap-4'>
              ...
              <div>
                ...
                />
                {errors.duration ? <p id='duration-error' className='text-red-500 text-xs mt-1' role='alert'>
                    {errors.duration}
                  </p> : null}
              </div>
            </div>
          ...
          <div>
            <div className='flex items-center justify-between mb-4'>
              <label className='block text-sm font-medium text-primary-text'>Exercises *</label>
              <Button
                onClick={addExercise}
                variant='outline'
                size='sm'
            ...
            {errors.exercises ? <p className='text-red-500 text-xs mt-2' role='alert'>
                {errors.exercises}
              </p> : null}
          </div>
        </div>
