...
router.get('/organizations/:orgId/export', verifyExportPermission, async (req: Request, res: Response) => {
  try {
...
router.get('/organizations/:orgId/export/:dataType', verifyExportPermission, async (req: Request, res: Response) => {
  try {
...
// Export audit logs
router.get('/organizations/:orgId/export/audit-logs', verifyExportPermission, async (req: Request, res: Response) => {
  try {
...
router.get('/organizations/:orgId/gdpr-export/:userId', verifyExportPermission, async (req: Request, res: Response) => {
  try {
